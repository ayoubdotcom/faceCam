...
public class FaceDetection {
   ...
   private static final String ROOT = new java.io.File("").getAbsolutePath();
    private static final String CASCADE_PATH = ROOT+"\\data\\haarcascade\\haarcascade_frontalface_alt_tree.xml";
...
//public static final CascadeClassifier CASCADE_FILE = new CascadeClassifier("haarcascade_frontalface_alt.xml");
    static {
        try {
            CROSS = ImageIO.read(new File(ROOT+"\\crosshair2.png"));
    ...
    public IplImage detectFace(IplImage image) {
        ...
        System.out.println("mostafa: "+image);
        CvSeq faces;
...
//            cvRectangle(highLighted, cvPoint(r.x(), r.y()), cvPoint(r.x() + r.width(), r.y() + r.height()), CvScalar.BLUE, 1, CV_AA, 0);
    ...
    public IplImage putName(IplImage originalImage, String nome) {
        ...
        cvPutText(originalImage, nome, cvPoint(r.x() +10, r.y() +10), font, CvScalar.WHITE);
