...
public class ListeHistoriques extends javax.swing.JDialog{

 
    public ListeHistoriques(Frame owner, ModalityType modalityType) {
    ...
    public static ListagemRegistros getInstance(){
        if (INSTANCE == null){
            synchronized(ListagemRegistros.class){
                if(INSTANCE == null){
                    INSTANCE = new ListagemRegistros(null, Dialog.ModalityType.DOCUMENT_MODAL);
                }
            }
        }
        return INSTANCE;
