...
public class IconUtils {
    ...
    static {
        ...
        try {
            icon16 = ImageIO.read(new File("icons/Logo.png"));
            icon32 = ImageIO.read(new File("icons/Logo.png"));
            icon64 = ImageIO.read(new File("icons/Logo.png"));
            icon128 = ImageIO.read(new File("icons/Logo.png"));
